...
draw_circle_meter(surf_circle, 0, 0, 128, percentage.v, _colour, c_gray, spr_meter, 100);
draw_surface_ext(surf_circle, 32, 32, 1, 1, 0, c_white, alpha.v);

draw_curved_meter(surf_curved, 0, 0, 64, 128, 30, 240, percentage.v, _colour, c_gray, spr_donut_meter, 100);
